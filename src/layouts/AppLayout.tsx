...
import { LayoutDashboard, ClipboardList, Users, ShoppingCart, Menu, X, LogOut, Tag, HardHat, Truck, Package, FileBarChart, CalendarDays, CalendarRange, Wallet, ReceiptText } from 'lucide-react'
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <aside className="hidden md:flex md:w-48 md:flex-col md:border-r md:border-gray-200 bg-white">
        <div className="flex flex-col items-center justify-center h-24 px-3 border-b border-gray-200">
          ...
          <span className="text-[9px] text-gray-400">ver. 1.23</span>
        </div>
