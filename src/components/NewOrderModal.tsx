          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-lg bg-gray-50 border border-gray-300 px-3 py-2 text-sm text-gray-800 placeholder-gray-400 outline-none focus:ring-2 focus:ring-amber-500/30 pr-8"
              />
              {color && <span className="absolute right-2 top-1/2 -translate-y-1/2"><ColorSwatch color={color} size="md" /></span>}
            </div>
          </div>
